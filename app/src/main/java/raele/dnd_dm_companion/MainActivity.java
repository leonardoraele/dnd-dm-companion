...
public class MainActivity extends AppCompatActivity
    ...
    public static enum NavigationDrawerItems {
        Section1(R.string.navitem_1, MainFragment.class),
        ;
        private final int mDescriptionId;
        private final Class<? extends Fragment> mFragmentClass;

        NavigationDrawerItems(int descriptionId, Class<? extends Fragment> fragmentClass) {
    ...
    public static final NavigationDrawerItems[] sNavItems = new NavigationDrawerItems[] {
            NavigationDrawerItems.Section1
    };
